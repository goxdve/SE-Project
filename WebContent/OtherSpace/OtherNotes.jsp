        ...
        <div class="row">
            <div class="span2  col-xs-12 col-sm-3 col-md-2">
                <ul class="nav nav-pills nav-stacked">
                    ...
                    <li class="active"><s:a href="OtherNotes.action?username=%{username}">发表攻略</s:a></li>
                </ul>
            </div>
            <div class="col-xs-12 col-sm-9 col-md-10">
            	<div style="padding: 5px" class="page-header">
				      <h1 style="font-size: 2em"><s:property value="username"/>的攻略</h1>
				</div>
				<table class="table table-striped table-hover cos-sm-12">
		    		<thead>
		      		...
		      		<tbody>
		      			<s:iterator value="allotherNotes" id="var" status="st">
		      				<tr>
		      					<td style="width: 300px;">
		              				<s:a href="noteInfo.action?name=%{#var.noteID}"><s:property value="#var.noteTitle" /></s:a>
		            			</td>
