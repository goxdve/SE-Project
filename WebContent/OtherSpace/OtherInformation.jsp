        ...
        <div class="row">
            <div class="span2  col-xs-12 col-sm-3 col-md-2">
                <ul class="nav nav-pills nav-stacked">
                    ...
                    <li class="active"><s:a href="OtherInformation.action?username=%{username}">个人信息</s:a></li>
                    <li><s:a href="OtherSchemes.action?username=%{username}">发布计划</s:a></li>
            ...
            <div class="col-xs-12 col-sm-9 col-md-10">
            	<div style="padding: 5px" class="page-header">
				      <h1 style="font-size: 2em"><s:property value="username"/>的信息</h1>
				</div>
				<div class="container">
				    ...
				    <div class="panel panel-primary">
				      ...
				      <div class="panel-body">
				        <div class="row">
				          ...
				          <div class="col-sm-5"><s:property value="user.age" /></div>
				        </div>
				        <hr/>
				        <div class="row">
				          <div class="col-sm-2">性别:</div>
				          	<s:if test="user.sex==1">
							   <div class="col-sm-5">女</div>
							</s:if>
							<s:else>
							   <div class="col-sm-5">男</div>
							</s:else>
				        </div>
				        <hr/>
				        <div class="row">
				          <div class="col-sm-2">电话号码:</div>
				          <div class="col-sm-5"><s:property  value="user.telephone" /></div>
				        </div>
				        <hr/>
				        <div class="row">
				          <div class="col-sm-2">签名:</div>
				          <div class="col-sm-10"><s:property value="user.signature" /></div>
				        </div>
				      </div>
				    </div>
				</div>
