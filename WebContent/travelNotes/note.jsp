...
<body>  
  <%  
    ...
    //String name=(String)ActionContext.getContext().get("username");
	...
	String noteID=date.toString()+time.toString();
    noteID=noteID.replace("-", "");
    noteID=noteID.replace(":", "");
    String path=getClass().getResource(".").getFile().toString()+noteID+".html";
  ...
  <form method="post" action=NewNote>
    <input type="hidden" name=noteTitle value=<%=title %>>
    <input type="hidden" name=travelNote value=<%=path %>>
